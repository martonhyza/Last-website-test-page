...
const PHRASES = [
  ...
  "responding to storm damage in 2 minutes",
  "turning missed calls into booked jobs",
  "automating your insurance follow-ups",
    ...
    <nav className={`fixed top-0 left-0 w-full z-[100] transition-all duration-300 ${scrolled ? 'bg-bg-void border-b border-border shadow-2xl py-2' : 'bg-bg-void/80 backdrop-blur-md py-3 md:py-4'}`}>
      <div className="max-w-7xl mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-medium text-text-secondary">
          {['Services', 'Case Studies', 'How It Works', 'Pricing'].map((item) => (
            <a 
              key={item} 
          ...
          <>
            ...
            >
              ...
              <div className="flex flex-col gap-6">
                {['Services', 'Case Studies', 'How It Works', 'Pricing'].map((item, i) => (
                  <motion.a 
